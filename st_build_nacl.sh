...
./qtbase/nacl-configure ${plat}_pnacl release 64 x86_64 -prefix $install_dir -commercial -I "$SW_DEV/stacks/texas_videoconf/third_party/third_party/openssl/openssl/include" -openssl-linked
