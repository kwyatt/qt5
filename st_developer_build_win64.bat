...
call "%SOURCE_DIRECTORY%\configure" -debug-and-release -force-debug-info -developer-build -opensource -confirm-license -shared -platform win32-msvc2015 -D QT_NO_BEARERMANAGEMENT -I "%SSL_DIRECTORY%\include" -L "%SSL_DIRECTORY%\lib" -openssl-linked -nomake examples -nomake tests -no-compile-examples -no-icu -mp -opengl dynamic OPENSSL_LIBS="-llibssl-33 -llibcrypto-34 -llibtls-4"
