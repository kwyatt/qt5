...
echo configuring ...
.\configure.bat -debug-and-release -force-debug-info -opensource -confirm-license -shared -nomake tools -nomake docs -nomake examples -nomake demos -nomake tests -mp -icu -platform win32-msvc2010 -angle -prefix "$(get-location)\$version" -I "$(get-location)\icu\include" -L "$(get-location)\icu\lib" -L "$icu_libdir"
