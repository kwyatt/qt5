...
"$SOURCE_DIRECTORY/qtbase/nacl-configure" ${plat}_pnacl release x86_64_translated -prefix "$BUILD_DIRECTORY/$version" -commercial -I "$SW_DEV/stacks/texas_videoconf/third_party/third_party/openssl/openssl/include" -openssl-linked -nacl-secondary-thread
